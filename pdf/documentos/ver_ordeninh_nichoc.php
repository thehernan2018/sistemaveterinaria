...
from t_ordeninhumacion toi, t_persona tpd, t_persona tps, t_difunto td, t_nichopabellon tnp,t_ventas tvs
WHERE  
toi.idsolicitante =tps.idpersona  and 
toi.iddifunto  =tpd.idpersona and 
toi.iddifunto  =td.idpersona  and 
toi.idnicho   =tnp.idnichopabellon  and 
toi.idventa =tvs.idventa  and  
toi.idventa='".$_GET['idventa']."'
...
");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_ordeninh_nichoc_html.php');
