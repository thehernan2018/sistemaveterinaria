...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
		...
		<tr>
           <td style="width:50%;" >
			<?php 
				$sql_cliente=mysqli_query($conexion,"select * from cliente where id_cliente='$idcliente'");
				$rw_cliente=mysqli_fetch_array($sql_cliente);
				echo $rw_cliente['nombre'].' '.$rw_cliente['apellidos'];
				echo "<br> Dirección:";
				echo $rw_cliente['direccion'];
				echo "<br> Teléfono: ";
				echo $rw_cliente['telf1'].'/'.$rw_cliente['telf2'];
				echo "<br> Email: ";
				echo $rw_cliente['email'];
				echo "<br> Ruc: ";
				echo $ruc;
				echo "<br> Razón Social: ";
				echo $rz;
				echo "<br> Dirección: ";
				echo $dir;
			?>
       ...
       <br>
		...
		<tr>
           <td style="width:35%;">
			<?php 
				$sql_user=mysqli_query($conexion,"SELECT * FROM t_persona where idpersona='$id_vendedor'");
				$rw_user=mysqli_fetch_array($sql_user);
				echo $rw_user['apellido']." ".$rw_user['nombre'];
			?>
		   </td>
