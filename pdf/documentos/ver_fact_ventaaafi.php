...
from t_ventas tvs, t_asignacionnichodifunto tand , t_persona tpd, t_persona tps, t_difunto td
WHERE  
tvs.idsolicitante=tps.idpersona  and 
tand.idafiliado =tpd.idpersona and 
tand.idafiliado =td.idpersona  and 
tand.idventa =tvs.idventa  and  
tvs.idventa='".$idventa."'
order by tvs.idventa desc");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_fact_ventaaafi_html.php');
