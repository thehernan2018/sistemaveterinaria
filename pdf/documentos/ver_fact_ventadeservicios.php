...
from t_ventas tvs, t_persona tpd, t_persona tps, t_usuario tu, t_difunto td
WHERE   
tvs.iddifunto=tpd.idpersona and 
tvs.idsolicitante=tps.idpersona and
tvs.idusuario=tu.idusuario and 
tvs.iddifunto=td.idpersona  and 
tvs.idventa='".$idventa."'
order by tvs.idventa desc");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_fact_ventadeservicios_html.php');
    ...
    try
    {
        ...
        // send the PDF
        $html2pdf->Output('ReciboNumero_0'.$numero_factura.'.pdf');
    }
