...
from t_ventas tvs, t_compromisopago tcp, t_persona tpd, t_persona tps, t_difunto td
WHERE  
tvs.idsolicitante=tps.idpersona  and 
tcp.iddifunto =tpd.idpersona and 
tcp.iddifunto =td.idpersona  and 
td.idpersona=tpd.idpersona and 
tcp.idsolicitante =tps.idpersona and  
tcp.idventa =tvs.idventa  and  
tvs.idventa='".$idventa."'
order by tvs.idventa desc");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_fact_ventadenichocre_html.php'); 
