<?php
	...
	if (empty($_POST['nombre_empresa'])) {
		...
		$telefono2=mysqli_real_escape_string($conexion,(strip_tags($_POST["telefono2"],ENT_QUOTES)));
		...
		$paginaweb=mysqli_real_escape_string($conexion,(strip_tags($_POST["pagina_web"],ENT_QUOTES)));
		
		$sql="UPDATE perfil SET nombre_empresa='".$nombre_empresa."', telefono='".$telefono."', telefono2='".$telefono2."', ruc='".$ruc."', email='".$email."', impuesto='".$impuesto."', moneda='".$moneda."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', codigo_postal='$codigo_postal', paginaweb='$paginaweb' WHERE id_perfil='1'";
