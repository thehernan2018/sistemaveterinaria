                                ...
                                <table class="table table-striped table-bordered table-hover datatable" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php //echo $row['precio']; ?><input type="text" name="precio" id="precio" value="<?php echo $row['precio']; ?>"> </td>
                                            <td class="center"><?php echo $row['stock']; ?></td>
                                            <td class="center"><?php echo $row['observacion']; ?></td>
                                            <td class="center"><?php echo $row['codigo']; ?></td>
                                           
                                            <td class="center">
                                                <button  cod='<?php echo $row['id_producto'];?>' pre='<?php echo $row['precio'];?>' st='<?php echo $row['stock'];?>'  class="btn btn-success btnAgregaVenta" type="button" >+</button>
                                            </td>
                                        </tr>
                                    <?php }  ?>
                                    </tbody>
